#To implement Python programs for file handling, specifically to create a text file,add course outcomes, and perform basic file operatios such as read, write,and append.

"""
Created on Mon Mar 23 14:52:49 2026
